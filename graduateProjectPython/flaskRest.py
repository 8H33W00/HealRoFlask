...
def heartDisease():
    ...
    parser.add_argument('cigsPerDay', type=str)
    parser.add_argument('prevalentHyp', type=str)
    parser.add_argument('male', type=str)
    parser.add_argument('currentSmoker', type=str)
    parser.add_argument('BPMeds', type=str)
    parser.add_argument('diabetes', type=str)
    parser.add_argument('prevalentStroke', type=str)
